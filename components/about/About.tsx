          ...
          <div className="w-full md:w-7/12 flex flex-col gap-12 md:gap-16 md:pt-4">
            ...
            >
              <p className="text-2xl md:text-3xl font-light leading-snug tracking-tight">
                Most AI products fail between the notebook and production. I focus on the space in
                between.
              </p>
            </motion.div>
            ...
            >
              <p>
                An API call to a model is just the beginning. I care about the engineering layer
                that turns raw AI capabilities into complete, maintainable products. My strength
                lies in end-to-end product ownership and the engineering systems surrounding
                AI&mdash;architecting secure backends, integrating specialized AI components into
                clean architectures, and delivering performant, user-centric frontends.
              </p>
